...
$sql_all = "select * from tbl_product limit $trang1,16"; // limit là chọn từ sản phẩm thứ 0, đến sản phẩm thứ 8
    ...
    <div class="content">
        ...
        <div class="section group">
            ...
            <div class="grid_1_of_4 images_1_of_4">
                <a href="details.php?proid=<?php echo $dong_all['productId'] ?>"><img
                            src="admin/uploads/<?php echo $dong_all['image'] ?>" alt=""/></a>
                <h2><?php echo $dong_all['productName'] ?></h2>
                <p><?php echo $fm->textShorten($result['product_desc'], 50) ?></p>
                <p><span class="price"><?php echo $fm->format_currency($dong_all['price']) . " " . "VND" ?></span></p>
                <div class="button"><span><a href="details.php?proid=<?php echo $dong_all['productId'] ?>"
